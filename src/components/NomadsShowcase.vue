  ...
  <section class="nomads-showcase-section">
    <div class="showcase-header">
      <div class="header-left">
        <h2 class="showcase-title">UI/UX与视觉设计需求专家实战模板库</h2>
...
const showcaseItems = computed<ShowcaseItem[]>(() => [
  {
    id: 'ai-sheji-1',
    tag: '玻璃拟态',
    title: '深色玻璃拟态 AI 绘画 APP 界面布局',
    prompt: '设计一款深色玻璃拟态风格的移动端 AI 创作 APP 首页，包含提示词输入框与画廊。',
    usageCount: '55.3k'
  },
  {
    id: 'ai-sheji-2',
    tag: '3D提示词',
    title: 'Midjourney 3D 渲染科技品牌吉祥物',
    prompt: '生成 Midjourney 高清提示词：3D IP mascot, cute robot, C4D render, studio lighting, --ar 16:9。',
    usageCount: '49.1k'
  },
  {
    id: 'ai-sheji-3',
    tag: 'B端后台',
    title: '企业级数据仪表盘 (Dashboard) UI 规范',
    prompt: '制定 B 端数据看板 UI 规范，包含暗黑模式图表配色、网格间距及数据卡片组件。',
    usageCount: '43.2k'
  },
  {
    id: 'ai-sheji-4',
    tag: '极简电商',
    title: '高端美妆品牌极简风 Web 首页构图',
    prompt: '设计高端护肤品电商网站首页排版，突出留白美学、大字号标题与高清产品细节。',
    usageCount: '37.6k'
  },
  {
    id: 'ai-sheji-5',
    tag: '图标设计',
    title: 'Neo-Brutalism 风格高对比度应用图标',
    prompt: '设计一组新丑风 App Icon，采用粗黑边框、高饱和度鲜艳配色与几何图形切块。',
    usageCount: '32.9k'
  },
  {
    id: 'ai-sheji-6',
    tag: 'UX微交互',
    title: '购物车添加与卡片 Hover 动画规范',
    prompt: '撰写前端组件 Hover 与 Active 微交互规范，提供 cubic-bezier 缓动曲线参数。',
    usageCount: '29.2k'
  }
]);
